        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffortWeight = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    RiskWeight = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    AlignmentWeight = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriorityCriteria", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<Guid>(type: "uuid", nullable: false),
                    ValueScore = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    EffortScore = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    RiskScore = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    AlignmentScore = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectObjectives", x => new { x.ProjectId, x.ObjectiveId });
                    table.ForeignKey(
